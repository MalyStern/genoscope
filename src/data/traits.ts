...
export const TRAITS: Trait[] = [
  ...
  },
  {
    ...
    category: 'senses',
    emoji: '👃',
    name: 'Sweat smell (androstenone)',
    gene: 'OR7D4',
    rsid: 'rs61729907',
    ref: 'https://www.snpedia.com/index.php/Rs61729907',
    genotypes: { CC: 'foul', CT: 'mid', TT: 'sweet' },
    outcomes: {
      foul: {
        key: 'foul',
        label: 'Smells foul',
        desc: 'You are sensitive to androstenone — the sweaty, urinous note in sweat and some pork.',
        tone: 'rose',
      },
      mid: {
        key: 'mid',
        label: 'In between',
        desc: 'One copy — you notice androstenone, but it does not overwhelm.',
        tone: 'teal',
      },
      sweet: {
        key: 'sweet',
        label: 'Smells sweet (or nothing)',
        desc: 'You barely smell androstenone, and may even find it faintly sweet or vanilla-like.',
        tone: 'violet',
      },
    },
  },
  {
    ...
    gene: 'EDAR',
    rsid: 'rs3827760',
    ref: 'https://www.snpedia.com/index.php/Rs3827760',
    genotypes: { GG: 'thick', AG: 'mid', AA: 'fine' },
    outcomes: {
      thick: {
        key: 'thick',
        label: 'Thick, straight hair',
        desc: 'The EDAR variant common in East Asian ancestry, linked to thicker, straighter hair strands.',
        tone: 'violet',
      },
      mid: {
        key: 'mid',
        label: 'In between',
        desc: 'One copy of the EDAR variant — hair thickness lands somewhere in the middle.',
        tone: 'teal',
      },
      fine: {
        key: 'fine',
        label: 'Finer hair',
        desc: 'You carry the common form, associated with finer hair strands.',
        tone: 'amber',
      },
    },
  },
